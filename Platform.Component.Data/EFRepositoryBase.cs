...
namespace Platform.Component.Data
{
    /// <summary>
    ...
    public abstract class EFRepositoryBase<TEntity> : IRepository<TEntity> where TEntity : Entity
    {
        ...
        private readonly IUnitOfWorkContext _efContext;
        ...
        public EFRepositoryBase(IUnitOfWork unitOfWork) 
        {
            if (unitOfWork is IUnitOfWorkContext)
            {
                ...
                _efContext=unitOfWork as IUnitOfWorkContext;
            }
            else {
        ...
        public virtual int Delete(object id, bool isSave = true)
        {
            ...
            TEntity entity = _efContext.Set<TEntity>().Find(id);
        ...
        public virtual int Delete(Expression<Func<TEntity, bool>> predicate, bool isSave = true)
        {
            ...
            List<TEntity> entities = _efContext.Set<TEntity>().Where(predicate).ToList();
