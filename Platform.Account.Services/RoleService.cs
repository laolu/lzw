...
namespace Platform.Account.Services
{
	public class RoleService:IRoleService
	{
        ...
        public int Insert(Role entity, bool isSave = true)
        {
        ...
        /// <param name="isSave"> 是否执行保存 </param>
        /// <returns> 操作影响的行数 </returns>
        public int Insert(IEnumerable<Role> entities, bool isSave = true)
        {
        ...
        /// <param name="isSave"> 是否执行保存 </param>
        /// <returns> 操作影响的行数 </returns>
        public int Delete(Role entity, bool isSave = true)
        {
        ...
        /// <param name="isSave"> 是否执行保存 </param>
        /// <returns> 操作影响的行数 </returns>
        public int Delete(IEnumerable<Role> entities, bool isSave = true)
        {
        ...
        /// <param name="isSave"> 是否执行保存 </param>
        /// <returns> 操作影响的行数 </returns>
        public int Delete(Expression<Func<Role, bool>> predicate, bool isSave = true)
        {
        ...
        /// <param name="isSave"> 是否执行保存 </param>
        /// <returns> 操作影响的行数 </returns>
        public int Update(Role entity, bool isSave = true)
        {
        ...
        public Role GetByKey(object key)
        {
